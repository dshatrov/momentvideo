  ...
  <div style="width: 100%; height: 100%; background-color: #000000;">
    <div id="flash_div" style="height: 100%;{{#MyPlayerPlaylist_ON}} padding-right: 200px;{{/MyPlayerPlaylist_ON}}">
      <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
	      ...
	      id="MyPlayer"
	      align="middle">
	<param name="movie" value="MyPlayer.swf?7"/>
	...
	<param name="FlashVars" value="{{#MyPlayerAutoplay_OFF}}autoplay=0&{{/MyPlayerAutoplay_OFF}}playlist={{#MyPlayerPlaylist_ON}}1{{/MyPlayerPlaylist_ON}}{{#MyPlayerPlaylist_OFF}}0{{/MyPlayerPlaylist_OFF}}&buffer={{MyPlayerBuffer}}{{#MyPlayerAutoplayStreamName_ON}}&uri={{MyPlayerAutoplayUri}}&stream={{MyPlayerAutoplayStreamName}}{{/MyPlayerAutoplayStreamName_ON}}"/>
	<embed              FlashVars="{{#MyPlayerAutoplay_OFF}}autoplay=0&{{/MyPlayerAutoplay_OFF}}playlist={{#MyPlayerPlaylist_ON}}1{{/MyPlayerPlaylist_ON}}{{#MyPlayerPlaylist_OFF}}0{{/MyPlayerPlaylist_OFF}}&buffer={{MyPlayerBuffer}}{{#MyPlayerAutoplayStreamName_ON}}&uri={{MyPlayerAutoplayUri}}&stream={{MyPlayerAutoplayStreamName}}{{/MyPlayerAutoplayStreamName_ON}}"
	    src="MyPlayer.swf?7"
	    bgcolor="#000000"
	    width="100%"
	    height="100%"
