...
public class Publisher extends Sprite
{
    ...
    private var record_mode : String;
    ...
    public function Publisher ()
    {
        ...
        record_mode = loaderInfo.parameters ["record_mode"];
...
// TODO Test for "unknown codec" messages with speex silence detection enabled.
//                } else {
...
//                avc_opts.setQuality (100000, 50);
            ...
            stream.publish (stream_name, record_mode);
    ...
    {
        stream.send ("MESSAGE", event.info.code);
    }
