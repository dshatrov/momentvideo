            ...
            function (data) {
                ...
                */
                ...
                $("#progressbar").click (function (e) {
                    ...
                    document ["MyPlayer"].setSource ("rtmp://{{ThisRtmpServerAddr}}/nvr", "{{NvrStreamName}}?t=" + (time * 1000));
                });
                ...
                $("#live-button").click (function (e) {
                    ...
                    document ["MyPlayer"].setSource ("rtmp://{{ThisRtmpServerAddr}}/live", "{{NvrStreamName}}");
                });
