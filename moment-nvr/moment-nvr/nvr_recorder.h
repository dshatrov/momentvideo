...
#ifndef MOMENT__NVR_RECORDER__H__
#define MOMENT__NVR_RECORDER__H__
...
class NvrRecorder : public Object
{
  private:
    StateMutex mutex;
...
#error This is likely unnecessary
    ...
    {
        NvrRecorder * const nvr_recorder;

        StreamTicket (NvrRecorder * const mt_nonnull nvr_recorder)
            : nvr_recorder (nvr_recorder)
        {}
    };
  ...
  public:
    ...
    void init (PagePool            * mt_nonnull page_pool,
     ...
     NvrRecorder (EmbedContainer *embed_container);
    ~NvrRecorder ();
};
...
#endif /* MOMENT__NVR_RECORDER__H__ */
