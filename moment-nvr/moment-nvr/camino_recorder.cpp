...
#include <moment-nvr/camino_recorder.h>


namespace MomentNvr {

CaminoRecorder::Recording::Recording ()
...
Time
CaminoRecorder::PrewriteQueueEntry::getDtsNanosec () const
{
    switch (type) {
        case t_Audio: {
...
mt_mutex (mutex) void
CaminoRecorder::recordStreamHeaders ()
{
}

mt_mutex (mutex) void
CaminoRecorder::recordPrewrite ()
{
}

mt_mutex (mutex) void
CaminoRecorder::recordAudioMessage (AudioMessage * const mt_nonnull audio_msg)
{
...
mt_mutex (mutex) void
CaminoRecorder::recordVideoMessage (VideoMessage * const mt_nonnull video_msg)
{
...
mt_mutex (mutex) void
CaminoRecorder::putToPrewriteQueue (MediaMessage * const mt_nonnull msg)
{
...
mt_mutex (mutex) void
CaminoRecorder::recordMessage (MediaMessage * const mt_nonnull msg)
{
#if 0
    switch (msg->msg_type) {
        case MediaMessage::t_Audio: {
...
CaminoRecorder::openVdatFile (ConstMemory const _filename,
...
mt_mutex (mutex) Result
CaminoRecorder::openIdxFile (ConstMemory const _filename)
{
}

mt_mutex (mutex) Result
CaminoRecorder::doStartRecording (Time const cur_unixtime_nanosec)
{
}
...
CaminoRecorder::writeMessage (WriteQueueEntry * const mt_nonnull entry)
{
  // TODO
}

mt_unlocks (mutex) void
CaminoRecorder::clearWriteQueueAndUnlock ()
{
...
CaminoRecorder::writeTask (void * const _self)
{
    CaminoRecorder * const self = static_cast <CaminoRecorder*> (_self);
...
MediaStream::Events const CaminoRecorder::stream_events = {
    stream_audioMessage,
    stream_videoMessage,
...
void
CaminoRecorder::stream_mediaDesc (MediaDesc_Audio * const media_desc__audio,
...
void
CaminoRecorder::stream_audioMessage (AudioMessage * const mt_nonnull audio_msg,
                                     void         * const _stream_ticket)
{
    StreamTicket * const stream_ticket = static_cast <StreamTicket*> (_stream_ticket);
    CaminoRecorder * const self = stream_ticket->camino_recorder;
...
void
CaminoRecorder::stream_videoMessage (VideoMessage * const mt_nonnull video_msg,
                                     void         * const _stream_ticket)
{
    StreamTicket * const stream_ticket = static_cast <StreamTicket*> (_stream_ticket);
    CaminoRecorder * const self = stream_ticket->camino_recorder;
...
void
CaminoRecorder::stream_closed (void * const _stream_ticket)
{
    StreamTicket * const stream_ticket = static_cast <StreamTicket*> (_stream_ticket);
    CaminoRecorder * const self = stream_ticket->camino_recorder;
...
void
CaminoRecorder::setMediaStream (MediaStream * const stream)
{
...
void
CaminoRecorder::init (PagePool            * const mt_nonnull page_pool,
...
CaminoRecorder::CaminoRecorder (EmbedContainer * const embed_container)
    : Object                         (embed_container),
