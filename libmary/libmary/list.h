...
#ifndef LIBMARY__LIST__H__
#define LIBMARY__LIST__H__
...
public:
    ...
    T& getFirst () const { return first->data; }
    T& getLast  () const { return last->data;  }
    ...
    unsigned long getNumElements () const { return numElements; }
    ...
    Element* appendEmpty () { return appendEmpty (last); }
    ...
    Element* append (const T &data) { return append (data, last); }
    ...
    Element* prependEmpty () { return prependEmpty (first); }
    ...
    Element* prepend (const T &data) { return prepend (data, first); }
  ...
  // ________________________________ iterator _________________________________
    ...
    public:
        iterator (List const &list) : cur (list.getFirstElement()) {}
        iterator () {}
...
// _________________________________ Iterator __________________________________
  ...
  // ___________________________ Reverse iterator ______________________________
	...
	bool operator == (rev_iter const &iter) const { return cur == iter.cur; }
	bool operator != (rev_iter const &iter) const { return cur != iter.cur; }
    };
